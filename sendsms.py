...
LOG_FILENAME = '/ug/ug2k11/csd/kondetimanikanta.purushotham/public_html/FreeSms/logging_example.out'
logging.basicConfig(filename=LOG_FILENAME,level=logging.DEBUG,)


import urllib, urllib2, urlparse, re, argparse, ConfigParser, os.path, getpass,sys, cookielib

default_auth_file=os.path.expanduser('/ug/ug2k11/csd/kondetimanikanta.purushotham/.sendsms.auth')
